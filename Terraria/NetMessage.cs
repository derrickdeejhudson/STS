...
namespace Terraria
{
    public class NetMessage
    {
        ...
        public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, string text = "", int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0, int number6 = -99)
        {
            if (Main.netMode == 0)
            {
                return;
            ...
            lock (NetMessage.buffer[num])
            {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (msgType == 4)
                            {
                                ...
                                num2 += 25 + bytes11.Length + 1; //was 24
                                ...
                                num3++;
                                NetMessage.buffer[num].writeBuffer[num3] = (byte) Main.player[(int) b].hero;
                                num3++;
                                ...
                                if (msgType == 5)
                                {
                                    ...
                                    else
                                    {
                                        if (number2 >= 70f && number2 <= 72f)
                                        {
                                            ...
                                            if (Main.player[number].ammo[num5].name == "" || Main.player[number].ammo[num5].stack == 0 || Main.player[number].ammo[num5].type == 0)
                                            {
                                                Main.player[number].ammo[num5].SetDefaults(0, false);
                                            }
                                            num4 = (short) Main.player[number].ammo[num5].stack;
                                            bytes14 = BitConverter.GetBytes((short) Main.player[number].ammo[num5].netID);
                                        }
                                        else
                                        {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            if (msgType == 16)
                                                                            {
                                                                                ...
                                                                                byte level = (byte) Main.player[(int) b42].level;
                                                                                byte invisCD = (byte) Main.player[(int) b42].invisCD;

                                                                                num2 += 1 + bytes75.Length + bytes76.Length + 2;
                                                                                ...
                                                                                num3 += 2;
                                                                                NetMessage.buffer[num].writeBuffer[num3] = level;
                                                                                num3++;
                                                                                NetMessage.buffer[num].writeBuffer[num3] = invisCD;
                                                                            }
                                                                            else
                                                                            {
                                                                                if (msgType == 17)
                                                                                                                    ...
                                                                                                                    else
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        else
                                                                                                                        {
                                                                                                                            if (msgType == 28)
                                                                                                                            {
                                                                                                                                ...
                                                                                                                                byte statusKiller = 255;
                                                                                                                                if (number6 != -99)
                                                                                                                                {
                                                                                                                                    statusKiller = (byte) (number6);
                                                                                                                                    num2++;
                                                                                                                                }
                                                                                                                                ...
                                                                                                                                if (statusKiller != 255)
                                                                                                                                {
                                                                                                                                    num3
                                                                                                                                        ++;
                                                                                                                                    NetMessage.buffer[num].writeBuffer[num3] = statusKiller;
                                                                                                                                }
                                                                                                                            }
                                                                                                                            else
                                                                                                                            {
                                                                                                                                                                            ...
                                                                                                                                                                            else
                                                                                                                                                                            {
                                                                                                                                                                                ...
                                                                                                                                                                                else
                                                                                                                                                                                {
                                                                                                                                                                                    if (msgType == 42)
                                                                                                                                                                                    {
                                                                                                                                                                                        ...
                                                                                                                                                                                        byte[] bytes193 = BitConverter.GetBytes((short) Main.player[(int) b77].manaShield);
                                                                                                                                                                                        num2 += 1 + bytes190.Length + bytes191.Length + bytes193.Length;
                                                                                                                                                                                        ...
                                                                                                                                                                                        num3 += 2;
                                                                                                                                                                                        Buffer.BlockCopy(bytes193, 0, NetMessage.buffer[num].writeBuffer, num3, 2);
                                                                                                                                                                                    }
                                                                                                                                                                                    else
                                                                                                                                                                                    {
                                                                                                                                                                                        if (msgType == 43)
                                                                                                                                                                                        {
                                                                                                                                                                                            ...
                                                                                                                                                                                            byte neg = (byte) number3;
                                                                                                                                                                                            num2 += 1 + bytes194.Length + 1;
                                                                                                                                                                                            ...
                                                                                                                                                                                            num3 += 2;
                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = neg;
                                                                                                                                                                                        }
                                                                                                                                                                                        else
                                                                                                                                                                                        {
                                                                                                                                                                                            if (msgType == 44)
                                                                                                                                                                                            {
                                                                                                                                                                                                ...
                                                                                                                                                                                                byte npcTeam = (byte) number5;
                                                                                                                                                                                                num2 += 2 + bytes197.Length + 2 + bytes198.Length;
                                                                                                                                                                                                ...
                                                                                                                                                                                                num3
                                                                                                                                                                                                    ++;
                                                                                                                                                                                                NetMessage.buffer[num].writeBuffer[num3] = npcTeam;
                                                                                                                                                                                                num3
                                                                                                                                                                                                    ++;
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                else
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    if (msgType == 50)
                                                                                                                                                                                                                    {
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        for (int n = 0; n < 10; n
                                                                                                                                                                                                                            ++)
                                                                                                                                                                                                                        {
                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte) Main.player[(int) b85].buffs[n].type;
                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                            Buffer.BlockCopy(BitConverter.GetBytes(Main.player[(int) b85].buffs[n].time), 0, NetMessage.buffer[num].writeBuffer, num3, 4);
                                                                                                                                                                                                                            num3 += 4;
                                                                                                                                                                                                                            int owner = (byte) Main.player[(int) b85].buffs[n].owner;
                                                                                                                                                                                                                            if (owner == -99) NetMessage.buffer[num].writeBuffer[num3] = byte.MaxValue;
                                                                                                                                                                                                                            else NetMessage.buffer[num].writeBuffer[num3] = (byte) owner;
                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                        }
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        else
                                                                                                                                                                                                                        {
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            else
                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                if (msgType == 53)
                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    NetMessage.buffer[num].writeBuffer[num3] = owner;
                                                                                                                                                                                                                                    num3++;
                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                    if (msgType == 54)
                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        for (int n = 0; n < 10; n++)
                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte) Main.npc[(int) b85].buffs[n].type;
                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                            Buffer.BlockCopy(BitConverter.GetBytes(Main.npc[(int) b85].buffs[n].time), 0, NetMessage.buffer[num].writeBuffer, num3, 4);
                                                                                                                                                                                                                                            num3 += 4;
                                                                                                                                                                                                                                            int owner = (byte) Main.npc[(int) b85].buffs[n].owner;
                                                                                                                                                                                                                                            if (owner == -99) NetMessage.buffer[num].writeBuffer[num3] = byte.MaxValue;
                                                                                                                                                                                                                                            else NetMessage.buffer[num].writeBuffer[num3] = (byte) owner;
                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    else
                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                        if (msgType == 70)
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] gameTime = BitConverter.GetBytes(number);
                                                                                                                                                                                                                                                                                            num2 += gameTime.Length;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(gameTime, 0, NetMessage.buffer[num].writeBuffer, 5, gameTime.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 71)
                                                                                                                                                                                                                                                                                            //money from creeps to team
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] money = BitConverter.GetBytes(number);
                                                                                                                                                                                                                                                                                            num2 += money.Length;
                                                                                                                                                                                                                                                                                            byte team = (byte) number2;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(money, 0, NetMessage.buffer[num].writeBuffer, 5, money.Length);
                                                                                                                                                                                                                                                                                            num3 += money.Length;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = team;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 72)
                                                                                                                                                                                                                                                                                            //exp from creeps to team
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] experience = BitConverter.GetBytes(number);
                                                                                                                                                                                                                                                                                            num2 += experience.Length;
                                                                                                                                                                                                                                                                                            byte team = (byte) number2;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(experience, 0, NetMessage.buffer[num].writeBuffer, 5, experience.Length);
                                                                                                                                                                                                                                                                                            num3 += experience.Length;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = team;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 73)
                                                                                                                                                                                                                                                                                            //hero learns new ability
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] whoAmI = BitConverter.GetBytes(number);
                                                                                                                                                                                                                                                                                            num2 += whoAmI.Length;
                                                                                                                                                                                                                                                                                            byte ability = (byte) number2;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(whoAmI, 0, NetMessage.buffer[num].writeBuffer, 5, whoAmI.Length);
                                                                                                                                                                                                                                                                                            num3 += whoAmI.Length;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = ability;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 74)
                                                                                                                                                                                                                                                                                            //add jungle points to counter
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] jungleCounter = BitConverter.GetBytes(number);
                                                                                                                                                                                                                                                                                            num2 += jungleCounter.Length;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(jungleCounter, 0, NetMessage.buffer[num].writeBuffer, 5, jungleCounter.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 75)
                                                                                                                                                                                                                                                                                            //update projectile AI
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte owner = (byte) number;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            //send mimic prefix/suffix
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte myPlayer = (byte) number;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte mimicPre = (byte) number2;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte mimicSuf = (byte) number3;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = myPlayer;
                                                                                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = mimicPre;
                                                                                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = mimicSuf;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 77)
                                                                                                                                                                                                                                                                                        //send new teleport to players
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] xpos = BitConverter.GetBytes((float)number);
                                                                                                                                                                                                                                                                                            num2 += xpos.Length;
                                                                                                                                                                                                                                                                                            byte[] ypos = BitConverter.GetBytes(number2);
                                                                                                                                                                                                                                                                                            num2 += ypos.Length;
                                                                                                                                                                                                                                                                                            byte[] nextBoss = BitConverter.GetBytes((int)number5);
                                                                                                                                                                                                                                                                                            num2 += nextBoss.Length;
                                                                                                                                                                                                                                                                                            num2 += 2;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(xpos, 0, NetMessage.buffer[num].writeBuffer, num3, xpos.Length);
                                                                                                                                                                                                                                                                                            num3 += xpos.Length;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(ypos, 0, NetMessage.buffer[num].writeBuffer, num3, ypos.Length);
                                                                                                                                                                                                                                                                                            num3 += ypos.Length;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte)number3;
                                                                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte)number4;
                                                                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(nextBoss, 0, NetMessage.buffer[num].writeBuffer, num3, nextBoss.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 78)
                                                                                                                                                                                                                                                                                        //send wave minions to players
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            num2 += 3;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte)number;
                                                                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte)number2;
                                                                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = (byte)number3;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 79)
                                                                                                                                                                                                                                                                                        //send multipliers to server
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte whoAmi = (byte)number;
                                                                                                                                                                                                                                                                                            num2++;
                                                                                                                                                                                                                                                                                            byte[] lastHitMult = BitConverter.GetBytes(Main.player[whoAmi].lastHitMult);
                                                                                                                                                                                                                                                                                            num2 += lastHitMult.Length;
                                                                                                                                                                                                                                                                                            byte[] damageMult = BitConverter.GetBytes(Main.player[whoAmi].damageMult);
                                                                                                                                                                                                                                                                                            num2 += damageMult.Length;
                                                                                                                                                                                                                                                                                            byte[] hurtMult = BitConverter.GetBytes(Main.player[whoAmi].hurtMult);
                                                                                                                                                                                                                                                                                            num2 += hurtMult.Length;
                                                                                                                                                                                                                                                                                            byte[] PKMult = BitConverter.GetBytes(Main.player[whoAmi].PKMult);
                                                                                                                                                                                                                                                                                            num2 += PKMult.Length;
                                                                                                                                                                                                                                                                                            byte[] whitePoints = new byte[8];
                                                                                                                                                                                                                                                                                            byte[] blackPoints = new byte[8];
                                                                                                                                                                                                                                                                                            if (Main.netMode == 2)
                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                whitePoints = BitConverter.GetBytes(Main.whitePoints);
                                                                                                                                                                                                                                                                                                num2 += whitePoints.Length;
                                                                                                                                                                                                                                                                                                blackPoints = BitConverter.GetBytes(Main.blackPoints);
                                                                                                                                                                                                                                                                                                num2 += blackPoints.Length;
                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = whoAmi;
                                                                                                                                                                                                                                                                                            num3++;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(lastHitMult, 0, NetMessage.buffer[num].writeBuffer, num3, lastHitMult.Length);
                                                                                                                                                                                                                                                                                            num3 += lastHitMult.Length;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(damageMult, 0, NetMessage.buffer[num].writeBuffer, num3, damageMult.Length);
                                                                                                                                                                                                                                                                                            num3 += damageMult.Length;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(hurtMult, 0, NetMessage.buffer[num].writeBuffer, num3, hurtMult.Length);
                                                                                                                                                                                                                                                                                            num3 += hurtMult.Length;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(PKMult, 0, NetMessage.buffer[num].writeBuffer, num3, PKMult.Length);
                                                                                                                                                                                                                                                                                            if (Main.netMode == 2)
                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                num3 += PKMult.Length;
                                                                                                                                                                                                                                                                                                Buffer.BlockCopy(whitePoints, 0, NetMessage.buffer[num].writeBuffer, num3, whitePoints.Length);
                                                                                                                                                                                                                                                                                                num3 += whitePoints.Length;
                                                                                                                                                                                                                                                                                                Buffer.BlockCopy(blackPoints, 0, NetMessage.buffer[num].writeBuffer, num3, blackPoints.Length);
                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 100)
                                                                                                                                                                                                                                                                                            //change serversock state
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte newState = (byte) number;
                                                                                                                                                                                                                                                                                            num2++;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = newState;
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 101)
                                                                                                                                                                                                                                                                                            //SENDING THAT YOU CONNECTED
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte hero = (byte) number;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte team = (byte) number2;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] nickName = Encoding.UTF8.GetBytes(text);
                                                                                                                                                                                                                                                                                            num2 += nickName.Length;
                                                                                                                                                                                                                                                                                            byte[] length = BitConverter.GetBytes(num2 - 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = hero;
                                                                                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = team;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(nickName, 0, NetMessage.buffer[num].writeBuffer, 7, nickName.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 102)
                                                                                                                                                                                                                                                                                            //SENDING THAT YOU LOCKED IN
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte[] nickName = Encoding.UTF8.GetBytes(text);
                                                                                                                                                                                                                                                                                            num2 += nickName.Length;
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(nickName, 0, NetMessage.buffer[num].writeBuffer, 5, nickName.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                        else if (msgType == 103)
                                                                                                                                                                                                                                                                                            //SENDING THAT YOU DISCONNECTED
                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                            byte[] msgBytes = BitConverter.GetBytes(msgType);
                                                                                                                                                                                                                                                                                            byte lockedIn = (byte) number;
                                                                                                                                                                                                                                                                                            num2
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            byte[] nickName = Encoding.UTF8.GetBytes(text);
                                                                                                                                                                                                                                                                                            num2 += nickName.Length;
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(length, 0, NetMessage.buffer[num].writeBuffer, 0, 4);
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(msgBytes, 0, NetMessage.buffer[num].writeBuffer, 4, 1);
                                                                                                                                                                                                                                                                                            NetMessage.buffer[num].writeBuffer[num3] = lockedIn;
                                                                                                                                                                                                                                                                                            num3
                                                                                                                                                                                                                                                                                                ++;
                                                                                                                                                                                                                                                                                            Buffer.BlockCopy(nickName, 0, NetMessage.buffer[num].writeBuffer, 6, nickName.Length);
                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                            }
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (msgType == 28)
                            {
                                ...
                                {
                                    if (num16 != ignoreClient && (NetMessage.buffer[num16].broadcast || (Netplay.serverSock[num16].state >= 3 && msgType == 28 /*10*/)) && Netplay.serverSock[num16].tcpClient.Connected)
                                    {
                                        bool flag3 = false;
                ...
                if (Main.verboseNetplay)
                {
                    ...
                    {
                        byte arg_5C0D_0 = NetMessage.buffer[num].writeBuffer[num21];
                    }
                }
        ...
        public static void SendSection(int whoAmi, int sectionX, int sectionY)
        {
            ...
            try
            {
                if (sectionX >= 0 && sectionY >= 0 && sectionX < Main.maxSectionsX && sectionY < Main.maxSectionsY)
                {
                    ...
                    int num = sectionX*200; //200
                    int num2 = sectionY*150; //150
                    for (int i = num2; i < num2 + 150; i++)
                    {
                        NetMessage.SendData(10, whoAmi, -1, "", 200, (float) num, (float) i, 0f, 0); //-1, "", 200
                    }
                    for (int j = 0; j < 200; j++)
                    {
        ...
        public static void syncPlayers()
        {
            ...
            for (int i = 0; i < 255; i++)
            {
                ...
                if (Netplay.serverSock[i].state == 10)
                {
                    ...
                    NetMessage.SendData(5, -1, i, Main.player[i].ammo[0].name, i, 70f, (float) Main.player[i].ammo[0].prefix, 0f, 0);
                    NetMessage.SendData(5, -1, i, Main.player[i].ammo[1].name, i, 71f, (float) Main.player[i].ammo[1].prefix, 0f, 0);
                    NetMessage.SendData(5, -1, i, Main.player[i].ammo[2].name, i, 72f, (float) Main.player[i].ammo[2].prefix, 0f, 0);
