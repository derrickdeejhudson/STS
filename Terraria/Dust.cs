        ...
        public static int NewDust(Vector2 Position, int Width, int Height, int Type, float SpeedX = 0f, float SpeedY = 0f, int Alpha = 0, Color newColor = default(Color), float Scale = 1f)
        {
            ...
            while (i < 6000)
            {
                if (!Main.dust[i].active)
                {
                    ...
                    if (Type >= 100)
                    {
                        Dust expr_331_cp_0 = Main.dust[i];
                        expr_331_cp_0.frame.X = expr_331_cp_0.frame.X - 1000;
                        Dust expr_34E_cp_0 = Main.dust[i];
                        expr_34E_cp_0.frame.Y = expr_34E_cp_0.frame.Y + 30;
                    }
                    ...
                    if (Main.dust[i].type == 135 || Main.dust[i].type == 6 || Main.dust[i].type == 75 || Main.dust[i].type == 169 || Main.dust[i].type == 29 || (Main.dust[i].type >= 59 && Main.dust[i].type <= 65) || Main.dust[i].type == 158)
                    {
                        ...
                        Dust expr_493_cp_0 = Main.dust[i];
                        expr_493_cp_0.velocity.X = expr_493_cp_0.velocity.X*0.3f;
                    ...
                    if (Main.dust[i].type == 33 || Main.dust[i].type == 52 || Main.dust[i].type == 98 || Main.dust[i].type == 99 || Main.dust[i].type == 100 || Main.dust[i].type == 101 || Main.dust[i].type == 102 || Main.dust[i].type == 103 || Main.dust[i].type == 104 || Main.dust[i].type == 105)
                    {
                        ...
                        //Dust expr_5F2_cp_0 = Main.dust[i];
                        //expr_5F2_cp_0.velocity.Y = expr_5F2_cp_0.velocity.Y + 1f;
                    }
                ...
                if (i < Main.numDust)
                {
                    if (Main.dust[i].active)
                    {
                        ...
                        if (Main.dust[i].type == 156)
                        {
                            ...
                            int arg_5BB_0 = Main.dust[i].type;
                            float num27 = num26;
                            float num28 = num26;
                            float num29 = num26;
                            num27 *= 0.5f;
                        ...
                        if (Main.dust[i].type == 6 || Main.dust[i].type == 135 || Main.dust[i].type == 127 || Main.dust[i].type == 187 || Main.dust[i].type == 75 || Main.dust[i].type == 169 || Main.dust[i].type == 29 || (Main.dust[i].type >= 59 && Main.dust[i].type <= 65) || Main.dust[i].type == 158)
                        {
                            ...
                            {
                                Dust expr_773_cp_0 = Main.dust[i];
                                expr_773_cp_0.velocity.Y = expr_773_cp_0.velocity.Y + 0.05f;
                            }
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    if (Main.dust[i].type == 187)
                                                    {
                                                        ...
                                                        Lighting.addLight((int) (Main.dust[i].position.X/16f), (int) (Main.dust[i].position.Y/16f), num31*0.2f, num31*0.45f, num31);
                                                    }
                                                    else
                                                    {
                                                        if (num31 > 0.6f)
                        ...
                        else
                        {
                            if (Main.dust[i].type == 159)
                            {
                                ...
                                else
                                {
                                    ...
                                    Dust expr_E1C_cp_0 = Main.dust[i];
                                    expr_E1C_cp_0.velocity.X = expr_E1C_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.02f;
                                    Dust expr_E49_cp_0 = Main.dust[i];
                                    expr_E49_cp_0.velocity.Y = expr_E49_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.02f;
                                    if (Main.rand.Next(5) == 0)
                                    {
                            ...
                            else
                            {
                                if (Main.dust[i].type == 164)
                                {
                                    ...
                                    else
                                    {
                                        Main.dust[i].scale -= 0.005f;
                                        Main.dust[i].velocity *= 0.9f;
                                        Dust expr_1048_cp_0 = Main.dust[i];
                                        expr_1048_cp_0.velocity.X = expr_1048_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.02f;
                                        Dust expr_1075_cp_0 = Main.dust[i];
                                        expr_1075_cp_0.velocity.Y = expr_1075_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.02f;
                                        if (Main.rand.Next(5) == 0)
                                        {
                                ...
                                else
                                {
                                    if (Main.dust[i].type == 173)
                                    {
                                        ...
                                        if (Main.dust[i].noGravity)
                                        {
                                            ...
                                            Dust expr_11C7_cp_0 = Main.dust[i];
                                            expr_11C7_cp_0.velocity.X = expr_11C7_cp_0.velocity.X + (float) Main.rand.Next(-20, 21)*0.01f;
                                            Dust expr_11F4_cp_0 = Main.dust[i];
                                            expr_11F4_cp_0.velocity.Y = expr_11F4_cp_0.velocity.Y + (float) Main.rand.Next(-20, 21)*0.01f;
                                        ...
                                        else
                                        {
                                            ...
                                            Main.dust[i].velocity *= 0.8f;
                                            Dust expr_1272_cp_0 = Main.dust[i];
                                            expr_1272_cp_0.velocity.X = expr_1272_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.005f;
                                            Dust expr_129F_cp_0 = Main.dust[i];
                                            expr_129F_cp_0.velocity.Y = expr_129F_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.005f;
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            if (Main.dust[i].type == 160 || Main.dust[i].type == 162)
                                            {
                                                ...
                                                {
                                                    Main.dust[i].velocity *= 0.8f;
                                                    Dust expr_14BA_cp_0 = Main.dust[i];
                                                    expr_14BA_cp_0.velocity.X = expr_14BA_cp_0.velocity.X + (float) Main.rand.Next(-20, 21)*0.04f;
                                                    Dust expr_14E7_cp_0 = Main.dust[i];
                                                    expr_14E7_cp_0.velocity.Y = expr_14E7_cp_0.velocity.Y + (float) Main.rand.Next(-20, 21)*0.04f;
                                                    Main.dust[i].scale -= 0.1f;
                                                }
                                                else
                                                {
                                                    Main.dust[i].scale -= 0.1f;
                                                    Dust expr_1549_cp_0 = Main.dust[i];
                                                    expr_1549_cp_0.velocity.X = expr_1549_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.02f;
                                                    Dust expr_1576_cp_0 = Main.dust[i];
                                                    expr_1576_cp_0.velocity.Y = expr_1576_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.02f;
                                            ...
                                            else
                                            {
                                                if (Main.dust[i].type == 168)
                                                {
                                                    ...
                                                    Main.dust[i].scale += 0.03f;
                                                    Dust expr_16FE_cp_0 = Main.dust[i];
                                                    expr_16FE_cp_0.velocity.X = expr_16FE_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.02f;
                                                    Dust expr_172B_cp_0 = Main.dust[i];
                                                    expr_172B_cp_0.velocity.Y = expr_172B_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.02f;
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        Dust expr_17A5_cp_0 = Main.dust[i];
                                                        expr_17A5_cp_0.velocity.X = expr_17A5_cp_0.velocity.X*0.98f;
                                                        Dust expr_17C2_cp_0 = Main.dust[i];
                                                        expr_17C2_cp_0.velocity.Y = expr_17C2_cp_0.velocity.Y*0.98f;
                                                        if (Main.dust[i].velocity.Y < 1f)
                                                        {
                                                            Dust expr_17F7_cp_0 = Main.dust[i];
                                                            expr_17F7_cp_0.velocity.Y = expr_17F7_cp_0.velocity.Y + 0.05f;
                                                        }
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            Dust expr_190E_cp_0 = Main.dust[i];
                                                            expr_190E_cp_0.velocity.Y = expr_190E_cp_0.velocity.Y*0.98f;
                                                            Dust expr_192B_cp_0 = Main.dust[i];
                                                            expr_192B_cp_0.velocity.X = expr_192B_cp_0.velocity.X*0.98f;
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                Main.dust[i].scale -= 0.01f;
                                                                Dust expr_1A19_cp_0 = Main.dust[i];
                                                                expr_1A19_cp_0.velocity.X = expr_1A19_cp_0.velocity.X*0.96f;
                                                                if (!Main.dust[i].noGravity)
                                                                {
                                                                    Dust expr_1A47_cp_0 = Main.dust[i];
                                                                    expr_1A47_cp_0.velocity.Y = expr_1A47_cp_0.velocity.Y + 0.1f;
                                                                }
                                                            }
                                                            else
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    {
                                                                        Dust expr_1D18_cp_0 = Main.dust[i];
                                                                        expr_1D18_cp_0.velocity.Y = expr_1D18_cp_0.velocity.Y*0.98f;
                                                                        Dust expr_1D35_cp_0 = Main.dust[i];
                                                                        expr_1D35_cp_0.velocity.X = expr_1D35_cp_0.velocity.X*0.98f;
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        ...
                                                                                        else
                                                                                        {
                                                                                            if (Main.dust[i].type == 66)
                                                                                            {
                                                                                                ...
                                                                                                Dust expr_21CA_cp_0 = Main.dust[i];
                                                                                                expr_21CA_cp_0.velocity.Y = expr_21CA_cp_0.velocity.Y*0.98f;
                                                                                                Dust expr_21E7_cp_0 = Main.dust[i];
                                                                                                expr_21E7_cp_0.velocity.X = expr_21E7_cp_0.velocity.X*0.98f;
                                                                                                Main.dust[i].scale += 0.02f;
                                                                                            ...
                                                                                            else
                                                                                            {
                                                                                                ...
                                                                                                {
                                                                                                    Main.dust[i].scale += 0.005f;
                                                                                                    Dust expr_2324_cp_0 = Main.dust[i];
                                                                                                    expr_2324_cp_0.velocity.Y = expr_2324_cp_0.velocity.Y*0.94f;
                                                                                                    Dust expr_2341_cp_0 = Main.dust[i];
                                                                                                    expr_2341_cp_0.velocity.X = expr_2341_cp_0.velocity.X*0.94f;
                                                                                                            ...
                                                                                                            else
                                                                                                            {
                                                                                                                ...
                                                                                                                else
                                                                                                                {
                                                                                                                    if (!Main.dust[i].noGravity && Main.dust[i].type != 41 && Main.dust[i].type != 44)
                                                                                                                    {
                                                                                                                        ...
                                                                                                                        {
                                                                                                                            Dust expr_296A_cp_0 = Main.dust[i];
                                                                                                                            expr_296A_cp_0.velocity.Y = expr_296A_cp_0.velocity.Y + 0.1f;
                                                                                                                        }
                                                                                                                    }
                                                                                                                }
                                                                                                            }
                        ...
                        if (Main.dust[i].type == 33 || Main.dust[i].type == 52 || Main.dust[i].type == 98 || Main.dust[i].type == 99 || Main.dust[i].type == 100 || Main.dust[i].type == 101 || Main.dust[i].type == 102 || Main.dust[i].type == 103 || Main.dust[i].type == 104 || Main.dust[i].type == 105 || Main.dust[i].type == 123)
                        {
                            ...
                            if (Main.dust[i].noGravity)
                            {
                                ...
                                Main.dust[i].scale += 0.03f;
                                Dust expr_2C38_cp_0 = Main.dust[i];
                                expr_2C38_cp_0.velocity.X = expr_2C38_cp_0.velocity.X*1.05f;
                                Dust expr_2C55_cp_0 = Main.dust[i];
                                expr_2C55_cp_0.velocity.Y = expr_2C55_cp_0.velocity.Y + 0.15f;
                            }
                        }
                        if (Main.dust[i].type == 35 && Main.dust[i].noGravity)
                        {
                            ...
                            if (Main.dust[i].scale < 1f)
                            {
                                Dust expr_2CC1_cp_0 = Main.dust[i];
                                expr_2CC1_cp_0.velocity.Y = expr_2CC1_cp_0.velocity.Y + 0.075f;
                            }
                            Dust expr_2CDE_cp_0 = Main.dust[i];
                            expr_2CDE_cp_0.velocity.X = expr_2CDE_cp_0.velocity.X*1.08f;
                            if (Main.dust[i].velocity.X > 0f)
                            {
                        ...
                        else
                        {
                            if (Main.dust[i].type == 152 && Main.dust[i].noGravity)
                            {
                                ...
                                if (Main.dust[i].scale < 1f)
                                {
                                    Dust expr_2E0D_cp_0 = Main.dust[i];
                                    expr_2E0D_cp_0.velocity.Y = expr_2E0D_cp_0.velocity.Y + 0.075f;
                                }
                                Dust expr_2E2A_cp_0 = Main.dust[i];
                                expr_2E2A_cp_0.velocity.X = expr_2E2A_cp_0.velocity.X*1.08f;
                                if (Main.dust[i].velocity.X > 0f)
                                {
                                    Main.dust[i].rotation += 0.01f;
                                }
                                        ...
                                        else
                                        {
                                            if (Main.dust[i].type == 34 || Main.dust[i].type == 35 || Main.dust[i].type == 152)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    Dust expr_319A_cp_0 = Main.dust[i];
                                                    expr_319A_cp_0.velocity.X = expr_319A_cp_0.velocity.X + (float) Main.rand.Next(-10, 10)*0.002f;
                        ...
                        if (Main.dust[i].type == 41)
                        {
                            Dust expr_33B4_cp_0 = Main.dust[i];
                            expr_33B4_cp_0.velocity.X = expr_33B4_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.01f;
                            Dust expr_33E1_cp_0 = Main.dust[i];
                            expr_33E1_cp_0.velocity.Y = expr_33E1_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.01f;
                        ...
                        else
                        {
                            ...
                            {
                                Dust expr_3575_cp_0 = Main.dust[i];
                                expr_3575_cp_0.velocity.X = expr_3575_cp_0.velocity.X + (float) Main.rand.Next(-10, 11)*0.003f;
                                Dust expr_35A2_cp_0 = Main.dust[i];
                                expr_35A2_cp_0.velocity.Y = expr_35A2_cp_0.velocity.Y + (float) Main.rand.Next(-10, 11)*0.003f;
                            ...
                            {
                                Dust expr_3720_cp_0 = Main.dust[i];
                                expr_3720_cp_0.velocity.X = expr_3720_cp_0.velocity.X*0.99f;
                            }
                        }
                        ...
                        if (Main.dust[i].type >= 130 && Main.dust[i].type <= 134)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    Main.dust[i].velocity *= 0.98f;
                                    Dust expr_3A67_cp_0 = Main.dust[i];
                                    expr_3A67_cp_0.velocity.Y = expr_3A67_cp_0.velocity.Y - 0.1f;
                                    Main.dust[i].scale += 0.0025f;
                                }
                                else
                                {
